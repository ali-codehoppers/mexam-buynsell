                ...
                <div id="formContainder">
                    <form id ="payAmount" method="POST" action="payAmount">
                        ...
                        <div>
                            ...
                            <div style="float: left; width: 48%; margin: 5px;"> 
                                <div style="float: left;">    
                                    <input type="text" size="25" maxlength="100" name="address1" class="field_big" value="123 Fake St"/>
                                </div>
                                <div style="float: left;" class="fieldError">                        
                        ...
                        <div>
                            ...
                            <div style="float: left; width: 48%; margin: 5px;"> 
                                <div style="float: left;">    
                                    <input type="text" size="25" maxlength="100" name="address2" class="field_big" value=""/>(optional)
                                </div>
                                <div style="float: left;" class="fieldError">                        
                        ...
                        <div>
                            ...
                            <div style="float: left; width: 48%; margin: 5px;"> 
                                <div style="float: left;">    
                                    <input type="text" size="25" maxlength="40" name="city" value="San Jose" class="field_big" />
                                </div>
                                <div style="float: left;" class="fieldError">                        
                        ...
                        <div>
                            ...
                            <div style="float: left; width: 48%; margin: 5px;"> 
                                <div style="float: left;">    
                                    <select name="state" class="field_big" style="width: 50px;" >
                                        <option></option>
                        ...
                        <div>
                            ...
                            <div style="float: left; width: 48%; margin: 5px;"> 
                                <div style="float: left;">    
                                    <input type="text" size="10" maxlength="10" name="zip" value="951311234" class="field_big"  style="width: 80px; text-align: center"/>(5 or 9 digits)
                                </div>
                                <div style="float: left;" class="fieldError">                        
                    ...
                    <!--
                                        <form method="POST" action="payAmount" name="frmDCC">
                                            <br>
                                            <center>
